...
function preload(){
  paddle_hit_sound= loadSound("ball_touch_paddel.wav");
...
function startGame(){
  gameStatus="start";
document.getElementById("stauts_heading").innerHTML="Game is loading";
}
...
function draw(){
 ...
 rect(0,0,20,700);
   ...
   //function move call which in very important
    move();
    document.getElementById("stauts_heading").innerHTML="Game has loaded";
}}
